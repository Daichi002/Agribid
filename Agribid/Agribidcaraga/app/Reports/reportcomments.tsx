...
const ReportScreen = () => {
  ...
  const { productId, commentsId } = route.params as { commentsId: string; productId: string };
  ...
  useEffect(() => {  console.log(productId, commentsId);}, []);
  ...
  const handleSubmitReport = async () => {
    ...
    try {
      ...
      console.log(`Report submitted for comment ID: ${commentsId} 
        by User ID: ${userId} with reason: ${selectedReason} 
        and details: ${additionalDetails}`);
