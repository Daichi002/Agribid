...
class BuyController extends Controller
{
    ...
    {
        return Buy::select('id', 'user_id', 'title', 'description', 'quantity', 'price', 'locate', 'image', 'created_at')
    ...
    public function getUserProducts(Request $request)
    {
        ...
        $products = Buy::where('user_id', $userId)
...
{ 
    ...
    public function show(Buy $product)
    {
        return response()->json([
            'product' => $product
        ]);
    ...
    public function update(Request $request, Buy $product)
    {
        $request->validate([
            'title' => 'required',
